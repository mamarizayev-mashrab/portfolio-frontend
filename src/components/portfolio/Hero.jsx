...
const Hero = () => {
    ...
    return (
        <section className="bg-[var(--background)] min-h-screen flex items-center relative overflow-hidden v-grid-bg">
            <div className="v-container relative z-10 pt-20">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-6xl md:text-8xl font-bold tracking-tighter text-[var(--foreground)] mb-8 leading-[0.9]">
                        {t('hero.name')}<span className="text-[var(--accents-3)]">.</span>
                    </h1>
                    ...
                    <p className="max-w-2xl text-lg md:text-xl text-[var(--accents-5)] mb-12 leading-relaxed">
                        {t('hero.subtitle')}
                    </p>
