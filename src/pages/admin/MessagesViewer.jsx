            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-0 relative">
                ...
                <div className={`v-card p-0 flex flex-col overflow-hidden ${showDetail ? 'hidden lg:flex' : 'flex'} h-full`}>
                    {isLoading ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center p-8 text-[var(--accents-4)]">
                            <svg className="w-12 h-12 mb-4 opacity-20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0a2 2 0 01-2 2H6a2 2 0 01-2-2m16 0l-8 5-8-5" /></svg>
                            <p className="text-sm">{t('admin.common.noResults')}</p>
                        </div>
                    ) : (
